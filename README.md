...
Reference from[：https://github.com/geerlingguy](https://github.com/geerlingguy)

Quick Start
-----------

To deploy jenkins you can use:

### Ansible

    ansible-playbook -vv jenkins.yaml

## Role Variables

Available variables are listed below, along with default values (see `roles/(jenkins|java)defaults/main.yml`):

    java_packages: java-1.8.0-openjdk

The java packages version.
...
The location at which the `jenkins-cli.jar` jarfile will be kept. This is used for communicating with Jenkins via the CLI.
    ...
    jenkins_plugins: ["git", "ssh", "gerrit-trigger", "extended-read-permission", "ssh-slaves", "ldap", "Ant", "build-timeout", "email-ext", "github", "pipeline-github"]
